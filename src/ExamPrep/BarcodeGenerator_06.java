...
public class BarcodeGenerator_06 {
    ...
    public static void main(String[] args) {
        ...
        int secondDigitFirstNum = firstNumber / 100 % 10; // 23 % 10 -> 3
        int thirdDigitFirstNum = firstNumber / 10 % 10; // 234 % 10 -> 4
        int forthDigitFirstNum = firstNumber % 10; // 5


        int firstDigitSecondNum = secondNumber / 1000;// 6
        int secondDigitSecondNum = secondNumber / 100 % 10; // 67 % 10 -> 7
        int thirdDigitSecondNum = secondNumber / 10 % 10; // 678 % 10 -> 8
        int forthDigitSecondNum = secondNumber % 10; // 9
            ...
            for (int j = secondDigitFirstNum; j <= secondDigitSecondNum ; j++) {
                ...
                for (int k = thirdDigitFirstNum; k <= thirdDigitSecondNum; k++) {
                    ...
                    for (int l = forthDigitFirstNum; l <= forthDigitSecondNum ; l++) {
                        ...
                        // i = 2, j = 3, k = 4, l = 5
                        //проверим дали числата са нечетни -> валиден баркод
